...
public class FqUserPayWayController extends BaseController {
    ...
    public Object uploadQrCode(HttpServletRequest request, MultipartFile file,Model model,Integer payWay) {
        ...
        try {
            ...
            fqUserPayWayExample.createCriteria().andUserIdEqualTo(user.getId()).andDelFlagEqualTo(YesNoEnum.NO.getValue()).andPayWayEqualTo(payWay);
            ...
            logger.info("用户：{}上传二维码:{}",user.getNickname(), picUrl);
        } catch (Exception e) {
