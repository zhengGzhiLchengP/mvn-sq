    ...
    public Object doDebug(DebugCondition debugCondition) {
        ...
        try {
            ...
            if(Method.POST.name().equals(interfaceMethod)){
                httpResponse = httpRequest.method(Method.POST).body(jsonObject.toString()).execute();
            }else if(Method.GET.name().equals(interfaceMethod)){
                httpResponse = httpRequest.method(Method.GET).body(jsonObject.toString()).execute();
            }
