...
import com.feiqu.common.enums.BusinessStatus;
...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.feiqu.common.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
        try {
            ...
            // 返回参数
            operLog.setJsonResult(com.alibaba.fastjson.JSON.toJSONString(jsonResult));
    ...
    private void setRequestValue(SysOperLog operLog) throws Exception {
        ...
        String params = com.alibaba.fastjson.JSON.toJSONString(map);
