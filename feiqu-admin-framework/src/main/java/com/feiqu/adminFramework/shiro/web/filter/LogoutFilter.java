package com.feiqu.adminFramework.shiro.web.filter;
        ...
        try
        {
            ...
            try
            {
                ...
                if (ObjectUtil.isNotEmpty(user))
                {
                    ...
                    // 记录用户退出日志
                    AsyncManager.me().execute(AsyncFactory.recordLogininfor(loginName, BizConstant.LOGOUT, MessageUtils.message("user.logout.success")));
                    // 清理缓存
