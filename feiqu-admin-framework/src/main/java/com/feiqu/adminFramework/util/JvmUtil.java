...
public class JvmUtil {
    ...
    public static String importFrom(int pid) {
        if (importFrom == null) {
            throw new BusinessException("jdk 环境不正常，没有找到：ConnectorAddressLink");
        }
    ...
    private static String getManagementAgent() {
        ...
        throw new BusinessException("JDK中" + file.getAbsolutePath() + " 文件不存在");
    }
