...
import com.feiqu.common.exception.file.FileNameLengthLimitExceededException;
import com.feiqu.common.exception.file.FileSizeLimitExceededException;
...
public class FileUploadUtils {
            ...
            throws FileSizeLimitExceededException, IOException, FileNameLengthLimitExceededException
    {
        ...
        FileUtil.writeBytes(file.getBytes(),desc);
...
//        filename = DateUtil.format(new Date(),"yyyy/MM/dd") + "/" + encodingFilename(filename) + extension;
    ...
    private static final String encodingFilename(String filename)
    {
        ...
        filename = DigestUtil.md5Hex(filename + System.nanoTime() + counter++);
        return filename;
    }
