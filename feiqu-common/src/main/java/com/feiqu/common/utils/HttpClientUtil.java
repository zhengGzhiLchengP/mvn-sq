...
public class HttpClientUtil {
    ...
    private static void init() {
        try {
            ...
            SocketConfig socketConfig = SocketConfig.custom().setSoTimeout(BizConstant.TIMEOUT).setTcpNoDelay(true).build();
            ...
            requestConfig = RequestConfig.custom().setSocketTimeout(BizConstant.TIMEOUT).
                    setConnectTimeout(BizConstant.TIMEOUT).
                    setConnectionRequestTimeout(BizConstant.TIMEOUT).
    ...
    public static String getWebPage(String url) throws IOException {
        ...
        request.setHeader("User-Agent", BizConstant.userAgentArray[new Random().nextInt(BizConstant.userAgentArray.length)]);
...
//		InputStream fis = HttpClientUtil.class.getResourceAsStream(name);
    ...
    public static RequestConfig.Builder getRequestConfigBuilder(){
        return RequestConfig.custom().setSocketTimeout(BizConstant.TIMEOUT).
                setConnectTimeout(BizConstant.TIMEOUT).
                setConnectionRequestTimeout(BizConstant.TIMEOUT).
                setCookieSpec(CookieSpecs.STANDARD);
    }
