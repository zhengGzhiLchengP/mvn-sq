...
public class FqTopicServiceImpl extends BaseServiceImpl<FqTopicMapper, FqTopic, FqTopicExample> implements FqTopicService {
    ...
    public void deleteData(long id) {
        ...
        FqTopicReplyExample fqTopicReplyExample = new FqTopicReplyExample();
        fqTopicReplyExample.createCriteria().andTopicIdEqualTo(id);
        fqTopicReplyMapper.deleteByExample(fqTopicReplyExample);
    }
}